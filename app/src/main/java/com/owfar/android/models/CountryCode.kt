package com.owfar.android.models
...
data class CountryCode private constructor(
    ...
    @JvmField val CREATOR: Parcelable.Creator<CountryCode> = object : Parcelable.Creator<CountryCode> {
        override fun createFromParcel(source: Parcel): CountryCode = CountryCode(source)
        override fun newArray(size: Int): Array<CountryCode?> = arrayOfNulls(size)
    }
    //endregion

    companion object {

        fun find(code: String?) = code?.let { code -> VALUES.find { it.code.compareTo(code, ignoreCase = true) == 0 } }
        ...
        val VALUES = arrayOf(
                ...
                CountryCode("Bolivia, Plurinational State of", "+591", "BO"),
                ...
                CountryCode("Congo, The Democratic Republic of the", "+243", "CD"),
                ...
                CountryCode("Holy See (Vatican City State)", "+379", "VA"),
                ...
                CountryCode("Korea, Democratic People's Republic of", "+850", "KP"),
                CountryCode("Korea, Republic of", "+82", "KR"),
                CountryCode("Kuwait", "+965", "KW"),
                CountryCode("Kyrgyzstan", "+996", "KG"),
                CountryCode("Lao People's Democratic Republic", "+856", "LA"),
                ...
                CountryCode("Macedonia, The Former Yugoslav Republic of", "+389", "MK"),
                ...
                CountryCode("Micronesia, Federated States of", "+691", "FM"),
                ...
                CountryCode("Palestinian Territory, Occupied", "+970", "PS"),
                ...
                CountryCode("Saint Helena, Ascension and Tristan Da Cunha", "+290", "SH"),
                ...
                CountryCode("South Georgia and the South Sandwich Islands", "+500", "GS"),
